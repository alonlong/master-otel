...
type Attachment struct {
	...
	Id         uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Email      uint32 `protobuf:"varint,2,opt,name=email,proto3" json:"email,omitempty"`
...
func (x *Attachment) GetEmail() uint32 {
	if x != nil {
		return x.Email
	}
	return 0
...
var file_proto_common_v1_common_proto_rawDesc = []byte{
	...
	0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
